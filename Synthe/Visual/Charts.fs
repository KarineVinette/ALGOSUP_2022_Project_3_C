...
module Charts =
    ...
    let Enveloped()=
      ...
      Enveloppe 1. 1. 0.2 0.1 0.5 0.3 |> Chart.Line |> Chart.WithOptions options |> Chart.Show
    ...
    let Flanged()=
      ...
      Flange(sinbyte 1. 440.) |> Chart.Line  |> Chart.WithOptions options |> Chart.Show
    ...
    let Echoed()=
      ...
      Echo  0.5 0.1(sinbyte 1. 100.)|> Chart.Line |> Chart.WithOptions options |> Chart.Show
    ...
    let Reverbed() =
      ...
      Reverb (sinbyte 1. 440.) |> Chart.Line |> Chart.WithOptions options |> Chart.Show 
